    ...
    <div class="col-10 text-center">
        ...
        <div class="card" style="background-color: rgb(75, 133, 155)">
            ...
            <div class="card-body">
                ...
                <p class="card-text">管理团队从事建筑行业十几年，建造师、五大员阵容齐全，核心管理层初期在编30人；
                    施工队伍都具有五年以上的行业经历，木、泥瓦、油漆、水电、拆除、保洁等各种工种人员齐备，电工焊工持证上岗，专业队伍初期在编70人；
                    借助网络技术、专业装饰经验、现代化工器具和检测仪，走进社区服务，力争房屋维修产业化、规模化、网络化。</p>
                <!--        <div class="text-center"><a href="http://www.humantang.com.cn/">官网</a></div>-->
                <div class="text-center">服务公众号</div>
                <img class="img-thumbnail" src="<?php echo $this->Url->build('/img/cases/hmt_qrcode.png'); ?>"
                     alt="Card image cap">
            </div>
        </div>
    </div>
